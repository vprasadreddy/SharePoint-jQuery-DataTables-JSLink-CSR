...
### The jQuery DataTables view is easy to sort, filter and search for an item/document/workflow task easily & quickly based on a keyword.

#### Steps to implement in SharePoint Lists.
...
#### Steps to implement in SharePoint Document Libraries.
...
#### Steps to implement in SharePoint Workflow Tasks List.
